...
namespace ForestVision.FV_TreeEditor
{
    public class FV_EditorWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            #region Tree Tools
            if (GUILayout.Button("Tree Tools", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
            ...
            if (GUILayout.Button("Reset Transform", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
            ...
            if (GUILayout.Button("Add FV_Items Script", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
                var go = Selection.activeGameObject;
                if (go == null)
                {
            ...
            if (GUILayout.Button("New Optimized", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
            ...
            #region Save Prefab
            if (GUILayout.Button("New Prefab", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
            ...
            if (GUILayout.Button("Screen Shot", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
            ...
            if (GUILayout.Button("Refresh Database", GUILayout.Width(160), GUILayout.MinHeight(height)))
            {
                InitContent();
                GeneratePreviews();
            }
            #endregion
            /*
			if (GUILayout.Button ("Show Help", GUILayout.Width (160), GUILayout.MinHeight (height))) {
